/* 
    ...
    |--------------|----------------------------------------------------------------------------|---------------|
    | bit	       |  1 (TRUE), 0 (FALSE) OU null(ausencia de registro, nenhum valor aplicado a ele)            | 
    ...
    |----------------+----------------------------------+-------------------------+---------------------------------|
    | date           | 0001-01-01 a 9999-12-31          | AAAA-MM-DD "PADRÃO BD   |            1900-01-01           |
    | ---------------+----------------------------------+-------------------------+---------------------------------|
