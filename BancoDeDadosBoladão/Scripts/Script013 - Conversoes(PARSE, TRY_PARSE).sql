...
PARSE,parece com o cast, temos possibilidade de trabalhar com uma CULTURA. PARSE (Nome_da_Cultura [data_type] [using culture* opcional]) - USA MAIS RECURSO QUE O CAST; 
TRY_PARSE
